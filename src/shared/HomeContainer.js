  ...
  return (
    <div>
      <section>
        ...
        <img
          src="https://wallpaperaccess.com/full/2321918.jpg"
          alt=""
        ...
        <section className="py-6 bg-gray-800 text-gray-50">
          <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
            <div className="py-6 md:py-0 md:px-6">
              ...
              <div className="space-y-4">
                <p className="flex items-center">
                  ...
                  <span>North Grizland, 23 road</span>
                </p>
                <p className="flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <p className="flex items-center">
                  ...
                  <span>crowngeeks@education.com</span>
                </p>
              </div>
            </div>
            <form
            ...
            >
              ...
              <button
                type="button"
                className="self-center px-8 py-3 text-lg rounded focus:ring hover:ring focus:ring-opacity-75 bg-violet-400 text-gray-900 focus:ring-violet-400 hover:ring-violet-700"
              >
                Submit
              </button>
            </form>
